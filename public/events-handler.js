class EventsHandler {
    ...
    registerAddPet() {
        $('#addpet').on('click', () => {
            ...
            if ($input.val() === "") {
                ...
                this.petsRepository.addPet($input.val()).then(()=>{this.petsRenderer.renderPets(this.petsRepository.pets)});
   ...
   async registerRemovePet() {
        this.$pets.on('click', '.remove-pet', (event) => {
            ...
            console.log(id);
            this.petsRepository.removePet(id).then(()=>{this.petsRenderer.renderPets(this.petsRepository.pets)});
            // this.petsRenderer.renderPets(this.petsRepository.pets);
          });
